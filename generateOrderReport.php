...
if (isset($_POST['orderSupplierName'])) {
    $orderSupplierName = $_POST['orderSupplierName'];
    if ($db->dbConnect()) {
        $data = $db->orderReportData("purchase_order", $orderSupplierName);
        ...
        $publicPdfUrl = $protocol . $serverDomain . '/PrototypeApi/Orderreport.pdf';
    ...
    echo "Error: 'Supplier Name' parameter is missing in the request.";
}
